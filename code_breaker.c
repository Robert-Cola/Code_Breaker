...
void print_game_header()
{
    ...
    printf("\033[0m"); // reset to standard colour text"
}
...
int game_mode_select()
{
    ...
    char line = ' ';
    line = getchar(); // gets rid of the leftover newline
...
void print_game_board(int *game_key, int guess_log[10][4], int *guess_correctness_log, int turn_number)
{
    ...
    */
    ...
    {
        printf("\t|\033[0;33m%2d\033[0m |          %d          %d          %d          %d      |\033[0;32m%2d\033[0m |\n",
